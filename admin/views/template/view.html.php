 ...
 *
 */
class CooltouramanViewTemplate extends JViewLegacy
{
	protected $form;
	...
	public function display($tpl = null)
	{
		...
		$this->canDo = JHelperContent::getActions('com_cooltouraman', 'template', $this->item->id);
	...
	protected function addToolbar()
	{
		...
		JToolbarHelper::title(
			JText::_('COM_COOLTOURAMAN_PAGE_' . ($checkedOut ? 'VIEW_COURSE_TEMPLATE' : ($isNew ? 'ADD_COURSE_TEMPLATE' : 'EDIT_COURSE_TEMPLATE'))),
		...
		else
		{
			...
			{
				JToolbarHelper::versions('com_cooltouraman.template', $this->item->id);
			}
