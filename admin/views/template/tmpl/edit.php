...
JFactory::getDocument()->addScriptDeclaration('
	Joomla.submitbutton = function(task)
	{
		...
		{
			' . $this->form->getField('course_description_text')->save() . '
...
<form action="<?php echo JRoute::_('index.php?option=com_cooltouraman&layout=edit&id=' . (int) $this->item->id); ?>" method="post" name="adminForm" id="item-form" class="form-validate">
	...
	<div class="form-horizontal">
		...
		<?php echo JHtml::_('bootstrap.endTab'); ?>
		<?php echo JHtml::_('bootstrap.addTab', 'myTab', 'publishing', JText::_('COM_COOLTOURAMAN_FIELDSET_PUBLISHING', true)); ?>
		...
		<?php echo JHtml::_('bootstrap.endTab'); ?>
		<?php echo JHtml::_('bootstrap.addTab', 'myTab', 'images', JText::_('COM_COOLTOURAMAN_INFO_AND_IMAGES', true)); ?>
		<div class="row-fluid form-horizontal-desktop">
			<div class="span6">
		...
		<?php if ($this->canDo->get('core.admin')) : ?>
			<?php echo JHtml::_('bootstrap.addTab', 'myTab', 'permissions', JText::_('COM_COOLTOURAMAN_RULES', true)); ?>
