...
/**
 * Methods supporting a list of holidays records.
 *
 */
class CooltouramanModelHolidays extends JModelList
{
	/**
	 * Constructor.
	 *
	...
	protected function getListQuery()
	{
		...
		$query->from($db->quoteName('#__cooltouraman_holiday') . ' AS a');
		...
		if ($this->getState('filter.search') !== '' && $this->getState('filter.search') !== null)
		{
			...
			$searches[] = 'a.day LIKE ' . $search;
			$searches[] = 'a.month LIKE ' . $search;
			$searches[] = 'a.year LIKE ' . $search;
